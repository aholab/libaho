...
-------  --------  --------  ----------
1.0.0    22/04/97  GNU       Codificacion inicial.
1.0.1    04/01/98  borja     remove some warnings.
...
// $$$ he desconectado deteccion GNUC
#ifdef __CC_GNUC__DISABLED

// no hace falta nada

#else   // #include "gstring.cpp"
