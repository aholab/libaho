...
typedef union _tagHeaderFileC30 {
	BYTE buffer[512] MINALIGN; /* Buffer de 512 bytes */
	struct _tagFile {
		CHAR8 FileID[BD_LENFILEID] MINALIGN; /* Identificador de fichero de voz "LTI" */
		...
		CHAR Locutor[BD_LENLOCUTOR] MINALIGN; /* Identificaci¢n del locutor */
		CHAR Sexo MINALIGN;                 /* Sexo del locutor */
		INT16 Edad MINALIGN;                 /* Edad del locutor */
		CHAR Origen[BD_LENORIGEN] MINALIGN; /* Origen del locutor */
		CHAR TipoMicrofono[BD_LENMICROFONO] MINALIGN; /* Tipo de micr¢fono usado */
		INT16 NumeroParesSegmentos MINALIGN; /* N£mero de pares de marcas almacenadas */
		CHAR Unidades[BD_LENUNIDADES] MINALIGN; /* Unidad de corpus */
		INT16 NumeroParesSubUnidades MINALIGN;
		} T;
	} HEADERFILEC30 MINALIGN;
